...
namespace chd.Poomsae.Scoring.App.Platforms.Android.BLE
{
    public class BLEServer : BaseBLEServer<BluetoothDevice, BluetoothGattService, BluetoothGattCharacteristic, BluetoothGattDescriptor>, IBroadCastService
    {
        ...
        private async Task CreateService()
        {
            ...
            this._characteristic = new BluetoothGattCharacteristic(UUID.FromString(BLEConstants.Result_Characteristic.ToGuidString()), GattProperty.Notify, GattPermission.Read | GattPermission.Write);
            this._descNotifyResult = new BluetoothGattDescriptor(UUID.FromString(BLEConstants.Notify_Descriptor.ToGuidString()), GattDescriptorPermission.Read | GattDescriptorPermission.Write);
